    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 pb-24 font-sans select-none" dir="rtl">
      ...
      <div className="relative bg-gradient-to-b from-[#002E52] via-[#064D83] to-[#003B68] text-white px-3 sm:px-4 pt-4 pb-12 sm:pb-14 overflow-hidden shadow-xs border-b border-[#D9A93A]/20">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <PlayCircle className="course-float w-16 h-16 left-[15%] top-[60%]" style={{ animationDuration: '10s', animationDelay: '0s' }} />
          <TrendingUp className="course-float w-12 h-12 left-[80%] top-[40%]" style={{ animationDuration: '12s', animationDelay: '-4s' }} />
          <Briefcase className="course-float w-10 h-10 left-[40%] top-[70%]" style={{ animationDuration: '14s', animationDelay: '-2s' }} />
          <Sparkles className="course-float w-8 h-8 left-[60%] top-[30%]" style={{ animationDuration: '9s', animationDelay: '-7s' }} />
        </div>
        ...
        <div className="max-w-md sm:max-w-xl mx-auto text-center relative z-10 space-y-3 pt-6">
          ...
          <div className="relative inline-block mb-2">
            ...
            <h1 className="relative text-2xl sm:text-3xl font-black text-white font-['Cairo',sans-serif] tracking-tight leading-tight">
              دليل الدورات <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E4B343] to-[#FDE08B]">التدريبية</span>
            </h1>
          </div>
          ...
          <p className="text-[13px] sm:text-sm text-slate-200 font-medium font-['Cairo',sans-serif] leading-relaxed max-w-[90%] mx-auto drop-shadow-md">
            طور مهاراتك، ارتقِ بمسيرتك المهنية، واكتشف برامج تدريبية عالمية تضعك في صدارة المنافسة في سوق العمل المتجدد.
          </p>
        </div>
      </div>
