...
const DESTINATION_BUBBLES: DestinationBubble[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=400&q=80', // Big Ben London
  },
  {
    id: 'ألمانيا',
    name: 'ألمانيا',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1560969184-10fe8719e047?auto=format&fit=crop&w=400&q=80', // Berlin
  },
  {
    id: 'الصين',
    name: 'الصين',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=400&q=80', // Great Wall / Beijing
  },
  {
    id: 'تركيا',
    name: 'تركيا',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=400&q=80', // Istanbul
  },
  {
    id: 'كندا',
    name: 'كندا',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?auto=format&fit=crop&w=400&q=80', // Canada
  },
  {
    id: 'فرنسا',
    name: 'فرنسا',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=400&q=80', // Paris Eiffel
  },
  {
    id: 'السعودية',
    name: 'السعودية',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1586724237569-f3d0c1dee8c6?auto=format&fit=crop&w=400&q=80', // Saudi
  },
  {
    id: 'اليابان',
    name: 'اليابان',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=400&q=80', // Tokyo
  },
];
...
export const FeaturedCountries: React.FC<FeaturedCountriesProps> = ({
  ...
  return (
    <section id="featured-countries-section" className="px-0.5 sm:px-1 py-3 w-full font-['Cairo',sans-serif]">
