...
const STUDENT_SERVICES = [
  {
    ...
    description: 'نتولى عملية التقديم بالكامل من اختيار الجامعة المناسبة لملفك وحتى الحصول على القبول النهائي.',
    imageUrl: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=200',
    color: 'bg-blue-50/60 text-[#064D83]',
  },
  {
    id: 's2',
    title: 'مراجعة وتدقيق الوثائق',
    description: 'تدقيق احترافي لخطابات الدافع (Motivation Letter) والسيرة الذاتية (CV) لتضمن لفت انتباه لجان القبول.',
    imageUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&q=80&w=200',
    color: 'bg-amber-50 text-[#D9A93A]',
  },
  {
    id: 's3',
    title: 'استشارات التأشيرة الدراسية',
    description: 'توجيه خطوة بخطوة لتحضير متطلبات التأشيرة الدراسية للبلد الوجهة وتجاوز المقابلة بنجاح.',
    imageUrl: 'https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&q=80&w=200',
...
const CORPORATE_SERVICES = [
  {
    ...
    description: 'نظام سحابي متكامل لإدارة وكالات التعليم، ومتابعة ملفات الطلاب وحالة قبولهم مركزياً باحترافية.',
  ...
  },
  {
    ...
    description: 'نربط الجامعات والمؤسسات التعليمية بوكلاء معتمدين لتوسيع قاعدة استقطاب الطلاب الدوليين.',
    imageUrl: 'https://images.unsplash.com/photo-1556761175-5973dc0f32d7?auto=format&fit=crop&q=80&w=200',
        ...
        <div className="flex flex-col items-center gap-4 mb-5">
          ...
          <div className="relative p-[2px] rounded-[14px] overflow-hidden group w-full max-w-[320px] shrink-0">
            ...
            <div className="relative flex bg-slate-50 p-1 rounded-xl w-full">
              ...
              >
                <GraduationCap className={`w-3.5 h-3.5 ${activeTab === 'students' ? 'text-[#D9A93A]' : 'text-slate-400'}`} />
              ...
              >
                <Building2 className={`w-3.5 h-3.5 ${activeTab === 'corporate' ? 'text-[#D9A93A]' : 'text-slate-400'}`} />
        ...
        <div key={activeTab} className="mt-4 flex flex-col gap-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
          {(activeTab === 'students' ? STUDENT_SERVICES : CORPORATE_SERVICES).map((service) => (
            ...
            >
              ...
              <div className={`shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-lg overflow-hidden flex items-center justify-center ${service.color} transition-transform group-hover:scale-105`}>
                <img 
