...
export const MajorDetailModal: React.FC<MajorDetailModalProps> = ({ major, onClose }) => {
  ...
  const isFellowship = major.degreeLevels?.includes('زمالة أبحاث') || major.code?.startsWith('FEL') || major.degreeLevelName?.includes('زمالة');
  const isDoctorate = (major.degreeLevels?.includes('دكتوراه') || major.code?.startsWith('DOC')) && !isFellowship;
  const isMaster = (major.degreeLevels?.includes('ماجستير') || major.code?.startsWith('MAS')) && !isDoctorate && !isFellowship;
  ...
  const postgradList = major.postDoctoralOpportunities || major.postgraduateOpportunities || [
    "الصحة العامة.",
    "الوبائيات.",
    "البحث السريري.",
    "التعليم الطبي.",
  ...
  return (
    <div className="w-full max-w-md mx-auto pt-0 pb-12 text-right font-['Tajawal',sans-serif] animate-in fade-in duration-200 bg-[#FAFAFA] min-h-screen relative">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="relative w-full h-[115px] sm:h-[120px]">
          ...
          >
            ...
            <path d="M 0,90 Q 250,112 500,90" fill="none" stroke="#D9A93A" strokeWidth="2.2" strokeLinecap="round" />
          </svg>
              ...
              <div className="w-11 h-11 rounded-full border-2 border-[#D9A93A] flex items-center justify-center p-1.5 shadow-[0_0_12px_rgba(200,162,74,0.5)] bg-gradient-to-br from-[#064D83] to-[#001C33] shrink-0">
                {isFellowship ? (
                  ...
                  <svg viewBox="0 0 40 40" className="w-full h-full">
                    ...
                    <polygon points="20,6 37,14 20,22 3,14" fill="url(#goldCapGrad)" stroke="#FFF2B2" strokeWidth="0.8" filter="url(#goldShine)" />
                    <path d="M9,17.5 v6 c0,3.5 4.8,6.5 11,6.5 s11,-3 11,-6.5 v-6" fill="url(#goldCapGrad)" stroke="#FFF2B2" strokeWidth="0.6" />
      ...
      {isFellowship ? (
          ...
          <div className="flex flex-col items-center justify-center pt-3.5 pb-2.5 px-3.5 bg-gradient-to-b from-slate-50/70 to-white">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                1. {isDoctorate ? 'معلومات تخصص الدكتوراه الأساسية' : isMaster ? 'معلومات تخصص الماجستير الأساسية' : 'معلومات التخصص الأساسية'}
              </h2>
            </div>
          ...
          <div className="divide-y divide-[#F2E8D5]/60 bg-white">
            ...
            {isDoctorate && (
              <div className="grid grid-cols-12 py-2.5 px-3.5 sm:px-4 items-start hover:bg-amber-50/20 transition-colors">
                ...
                <div className="col-span-8 text-[11px] font-bold text-slate-800 leading-relaxed">
                  MAS-0001 — العلوم الطبية، مع إمكان الارتباط بالعلوم الطبية الحيوية والبحوث السريرية
                </div>
              </div>
            )}
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-3 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                2. {isDoctorate ? 'طبيعة الدكتوراه وهدفها' : isMaster ? 'نبذة عن تخصص الماجستير' : 'نبذة عن التخصص'}
              </h2>
            </div>
            {/* Glowing Gold Underline */}
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
            ...
            <div className="p-3 sm:p-3.5 rounded-2xl bg-gradient-to-br from-slate-50/90 to-amber-50/20 border border-[#F2E8D5]/70 text-right space-y-2">
              <p className="text-[11px] sm:text-[11.5px] font-bold text-slate-700 leading-[2] text-justify">
                {isDoctorate 
                  ...
                  : major.aboutMajor || "البرنامج الأكاديمي المتقدم الذي يركز على تزويد الطالب بالمعرفة العلمية الشاملة والمهارات التطبيقية والبحثية المتقدمة لإعداده للمسارات المهنية والأكاديمية."}
              </p>
              {isDoctorate && (
        ...
        {isDoctorate && (
          <DoctorateAcademicBackgroundsSlider major={major} />
        )}
            ...
            <div className="space-y-3 text-right">
              <div className="p-3 rounded-2xl bg-slate-50/80 border border-[#F2E8D5]/70 text-right">
                <p className="text-[11px] sm:text-[11.5px] font-bold text-slate-700 leading-[1.9]">
                  يستهدف برنامج الماجستير الخريجين من التخصصات الطبية والصحية والعلمية التالية المؤهلين للالتحاق:
                </p>
              </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {major.advancedTheory.map((item, idx) => (
                      <div key={idx} className="flex items-start gap-2 p-2.5 rounded-xl bg-white border border-[#F2E8D5]/90">
                        ...
                        <span className="text-[10.5px] font-bold text-slate-800 leading-relaxed">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-3 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '7. مجالات البحث والتخصصات الدقيقة' : isMaster ? '4. المسارات والتخصصات الدقيقة الشائعة' : '3. المسارات والتخصصات الدقيقة'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-3 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '13. المهارات البحثية والمهنية المتقدمة' : isMaster ? '5. المهارات التخصصية المكتسبة' : '4. المهارات التخصصية التي يكتسبها الطالب'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-4 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '14. مجالات العمل بعد الدكتوراه' : isMaster ? '6. مجالات العمل والفرص المهنية بعد التخرج' : '5. مجالات العمل بعد التخرج'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-4 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '15. أهم الوظائف المرتبطة' : isMaster ? '7. أهم الوظائف المرتبطة بالدرجة' : '6. أهم الوظائف المرتبطة'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
            ...
            <table className="w-full text-right border-collapse min-w-[500px]">
              <thead>
                <tr className="bg-gradient-to-l from-[#064D83]/5 to-white border-b border-[#F2E8D5]/80">
                  <th className="py-3 px-4 text-[11px] sm:text-[11.5px] font-black text-[#064D83] w-[30%] whitespace-nowrap">الوظيفة</th>
                  <th className="py-3 px-4 text-[11px] sm:text-[11.5px] font-black text-[#064D83] w-[30%] whitespace-nowrap">مدى مناسبة الدرجة</th>
                  <th className="py-3 px-4 text-[11px] sm:text-[11.5px] font-black text-[#064D83] w-[40%]">الملاحظة</th>
                </tr>
              </thead>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-4 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '16. ما بعد الدكتوراه والمسارات اللاحقة' : isMaster ? '8. فرص ما بعد الماجستير والمسارات المستقبلية' : '7. فرص الدراسات العليا'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-4 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '17. الدكتوراه المشابهة والفروق' : isMaster ? '9. التخصصات المشابهة والفرق بينها' : '8. التخصصات المشابهة'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
        ...
        <div className="relative w-full bg-white rounded-none p-3.5 sm:p-4 border-y border-[#064D83]/40 shadow-md shadow-slate-200/60 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center mb-3.5 pt-0.5">
            <div className="flex items-center justify-center gap-2 mb-1.5">
              ...
              <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight">
                {isDoctorate ? '18. التنبيه الأكاديمي والمهني' : isMaster ? '10. التنبيه الأكاديمي والمهني الحاسم' : '9. التنبيه الأكاديمي والمهني'}
              </h2>
            </div>
            <div className="w-[140px] h-[1.5px] bg-gradient-to-r from-transparent via-[#D9A93A] to-transparent shadow-[0_0_8px_rgba(200,162,74,0.7)]" />
          </div>
          ...
          <div className="space-y-2 text-right">
            {isDoctorate ? (
              ...
              alertPoints.map((point, pIdx) => (
                ...
                >
                  <div className={`w-5 h-5 rounded-lg flex items-center justify-center shrink-0 mt-0.5 font-black text-[10px] ${
                    pIdx === 0 ? 'bg-[#064D83]/10 text-[#064D83]' : 'bg-[#D9A93A]/20 text-[#064D83]'
                  }`}>
                    {point.num || (pIdx + 1)}
                  </div>
